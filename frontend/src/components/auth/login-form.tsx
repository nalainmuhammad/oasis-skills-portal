  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 h-12 bg-white hover:bg-gray-50 text-gray-800 font-medium rounded-xl border border-gray-200 transition-all hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed mb-6"
      >
        {isGoogleLoading ? (
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-oasis-bgSecondary px-3 text-foreground/40">or sign in with email</span>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="space-y-5">
        {isVerified && !error && (
          <div className="bg-oasis-emerald/10 border border-oasis-emerald/30 text-oasis-emerald p-3 rounded-xl text-sm font-medium text-center">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <Link href="/forgot-password" className="text-xs text-oasis-emerald hover:underline">Forgot password?</Link>
          </div>
          <div className="relative">
      ...
      <div className="mt-6 text-center text-sm text-foreground/40">
        Don't have an account? <Link href="/register" className="text-oasis-emerald hover:underline">Sign up</Link>
      </div>
    </>
  );
}
